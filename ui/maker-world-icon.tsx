...
/**
 * MakerWorld brand mark (dashboard-icons, homarr-labs), inlined as a
 * `currentColor` SVG so it follows the same sizing/coloring API as the
 * lucide-react and react-icons icons used alongside it.
 */
export function MakerWorldIcon({ size = 18, ...props }: MakerWorldIconProps) {
  return (
    <svg
